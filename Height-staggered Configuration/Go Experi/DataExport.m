...
function [dataset,model,range_numerical] = DataExport(modelFilename,datafilename,datatag,range_txt_x,range_txt_y,range_txt_z,X,Y,Z,exper)

    [range_txt,range_numerical] = range_settle(range_txt_x,range_txt_y,range_txt_z,X,Y,Z);

    [dataset,model] = DataProcess(modelFilename,datafilename,datatag,exper,range_txt);
